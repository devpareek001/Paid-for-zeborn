...
PICS = (environ.get('PICS', 'https://graph.org/file/6420969a212679160d8ea-4fd062764a1ebca3d3.jpg https://envs.sh/s/vVv5dn04LU1mmsUS1OlaTg/Eoj.jpg https://envs.sh/s/vVv5dn04LU1mmsUS1OlaTg/Eoj.jpg')).split() 
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6914788581 5186213362').split()] 
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Jantu:Jantu@cluster0.o836qjs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002782726608'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002782726608'))
...
SHORTENER_API = environ.get("SHORTENER_API", "7472bdb779e7ef88383d56468086022c002a918f")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "joinurls.com")

SHORTENER_API2 = environ.get("SHORTENER_API2", "7472bdb779e7ef88383d56468086022c002a918f")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "joinurls.com")

SHORTENER_API3 = environ.get("SHORTENER_API3", "7472bdb779e7ef88383d56468086022c002a918f")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "joinurls.com")
