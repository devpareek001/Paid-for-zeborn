...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003017167191'))  
...
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002997614192 -1002767330984') # add multiple channels here, separated by single space
